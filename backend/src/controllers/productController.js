...
exports.createProduct = async (req, res) => {
  try {
    ...
    // Validate Price (Phải lớn hơn 0, Max 100,000,000)
    ...
    if (numPrice <= 0 || numPrice > 100000000) {
      return res.status(400).json({ message: "Price must be greater than 0 and up to 100,000,000" });
    }
