...
fail_font = Font(name='Segoe UI', size=10, bold=True, color='922B21')
...
# 28 Test cases mapped from postman_test_run.json
test_cases_data = [
    [
        'EP-PROD-01',
        ...
        'HTTP 201 Created (250ms). Món ăn được tạo nhưng assertion so sánh strict type category_id bị lệch ("1" vs 1).',
        'FAIL'
    ],
    [
        'EP-PROD-02',
        ...
        'HTTP 400 Bad Request (3ms). Hệ thống từ chối thiếu tên: "Tên món ăn không được để trống".',
        'PASS'
    ],
    [
        'EP-PROD-03',
        ...
        '{\n  "name": "   ",\n  "price": 50000,\n  "category_id": 1\n}',
        'HTTP 400 Bad Request. Báo lỗi: "Tên món ăn không được để trống".',
        'HTTP 400 Bad Request (4ms). Hệ thống chặn tên rỗng: "Tên món ăn không được để trống".',
        'PASS'
    ],
    [
        'EP-PROD-04',
        ...
        'HTTP 400 Bad Request (2ms). Hệ thống chặn độ dài tên món vượt 150 ký tự: "Product name cannot exceed 150 characters".',
        'PASS'
    ],
    [
        'EP-PROD-05',
    ...
    [
        ...
        'HTTP 400 Bad Request (2ms). Hệ thống chặn thiếu price: "Price is required and must be a valid number".',
        'PASS'
    ],
    [
        'EP-PROD-07',
    ...
    [
        ...
        '{\n  "name": "Sushi Test",\n  "price": 100000001,\n  "category_id": 1\n}',
        'HTTP 400 Bad Request. Báo lỗi: "Price must be greater than 0 and up to 99,999,999.99".',
        'HTTP 400 Bad Request (4ms). Hệ thống chặn giá vượt ngưỡng tối đa: "Price must be greater than 0 and up to 99,999,999.99".',
        'PASS'
    ],
    [
        'EP-PROD-09',
    ...
    [
        'EP-PROD-10',
        'Tạo món ăn không truyền stock (mặc định nhận 0)',
        'PV3b',
        'Admin đã đăng nhập',
        '{\n  "name": "Sushi Test No Stock",\n  "price": 50000,\n  "category_id": 1\n}',
        'HTTP 201 Created. Món ăn được tạo với tồn kho mặc định bằng 0.',
        'HTTP 201 Created (260ms). Món ăn được tạo thành công, trường stock tự động gán giá trị mặc định là 0.',
        'PASS'
    ],
    [
        'EP-PROD-11',
        ...
        'HTTP 201 Created (223ms). Dữ liệu món ăn được lưu đúng với stock=50.',
        'PASS'
    ],
    [
        'EP-PROD-12',
    ...
    [
        'EP-PROD-13',
        'Tạo món ăn với stock > 10.000 / tràn số',
        'PX10',
        'Admin đã đăng nhập',
        '{\n  "name": "Sushi Test",\n  "price": 50000,\n  "stock": 2147483648,\n  "category_id": 1\n}',
        'HTTP 400 Bad Request. Hệ thống từ chối stock vượt ngưỡng.',
        'HTTP 400 Bad Request (3ms). Hệ thống từ chối stock vượt ngưỡng quy định: "Stock must be an integer between 0 and 2,147,483,647".',
        'PASS'
    ],
    [
        'EP-PROD-14',
        ...
        '{\n  "name": "Sushi Test",\n  "price": 50000,\n  "stock": 12.5,\n  "category_id": 1\n}',
        'HTTP 400 Bad Request. Báo lỗi: "Stock must be an integer between 0 and 2,147,483,647".',
        'HTTP 400 Bad Request (5ms). Hệ thống chặn tồn kho không phải số nguyên: "Stock must be an integer between 0 and 2,147,483,647".',
        'PASS'
    ],
    [
        'EP-PROD-15',
    ...
    [
        ...
        'HTTP 201 Created (238ms). Món ăn được tạo thành công với đúng mô tả.',
        'PASS'
    ],
    [
        'EP-PROD-17',
        ...
        'HTTP 201 Created (232ms). Backend cũ chưa có validate độ dài description nên tạo thành công thay vì trả về 400.',
        'FAIL'
    ],
    [
        'EP-PROD-18',
        ...
        'HTTP 201 Created (228ms). Backend cũ chưa có validate kiểu description nên tạo thành công thay vì trả về 400.',
        'FAIL'
    ],
    [
        'EP-PROD-19',
        ...
        'HTTP 201 Created (232ms). Món ăn tạo thành công nhưng assertion so sánh strict type category_id bị lệch ("1" vs 1).',
        'FAIL'
    ],
    [
        'EP-PROD-20',
    ...
    [
        ...
        'HTTP 400 Bad Request (3ms). Hệ thống trả về 400 nhưng thông báo lỗi là "Category ID is required..." thay vì "Category ID must be a positive integer".',
        'FAIL'
    ],
    [
        'EP-PROD-22',
        ...
        'HTTP 400 Bad Request (122ms). Kiểm tra khóa ngoại không tồn tại và trả về: "Category not found".',
        'PASS'
    ],
    [
        'EP-PROD-23',
        ...
        'HTTP 201 Created (226ms). Món ăn được tạo với isAvailable=true.',
        'PASS'
    ],
    [
        'EP-PROD-24',
        ...
        'HTTP 201 Created (224ms). Món ăn được tạo thành công với isAvailable=false trong CSDL.',
        'PASS'
    ],
    [
        'EP-PROD-25',
        ...
        'HTTP 201 Created (229ms). Món ăn được tạo và tự động gán isAvailable=true.',
        'PASS'
    ],
    [
        'EP-PROD-26',
        ...
        'HTTP 201 Created (245ms). Backend cũ chưa validate kiểu boolean cho isAvailable nên ép kiểu "true" và tạo thành công thay vì trả về 400.',
        'FAIL'
    ],
    [
        'EP-PROD-27',
        ...
        'HTTP 201 Created (230ms). Món ăn được tạo với URL ảnh hợp lệ.',
        'PASS'
    ],
    [
        'EP-PROD-28',
        ...
        'HTTP 201 Created (224ms). Backend cũ chưa validate độ dài URL ảnh nên tạo thành công thay vì trả về 400.',
        'FAIL'
    ]
]
...
ws_results.column_dimensions['G'].width = 54
...
print("Excel updated with exact test run execution results successfully!")
